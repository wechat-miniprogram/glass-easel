...
describe('Events', function () {
  ...
  describe('#addListenerToElement', function () {
    it('should attach listeners to full-rendering elements', function () {
      ...
      glassEasel.triggerEvent(
        ...
        'customevent',
        { a: 1 },
        { bubbles: true, composed: true, extraFields: { a: 2 } },
      )
  ...
  describe('#triggerEvent', function () {
    it('should trigger global events', function () {
      ...
      glassEasel.triggerExternalEvent(child, child.$.inner, 'customevent', undefined, {
        bubbles: true,
        composed: true,
      })
    ...
    it('should convert event target correctly (in full mode)', function () {
      ...
      glassEasel.triggerEvent(e3.$.inner, 'customevent', undefined, {
        bubbles: true,
        composed: true,
      })
    ...
    it('should convert event target correctly (in native mode)', function () {
      ...
      glassEasel.triggerExternalEvent(e3, e3.$.inner, 'customevent', undefined, {
        bubbles: true,
        composed: true,
      })
      expect(callOrder).toStrictEqual([5, 4, 3, 2, 1])
    ...
    it('should convert event target correctly (in full and native mode)', function () {
      ...
      regElem({
        ...
        template:
          '<events-target-a id="a"> <events-target-b id="b"></events-target-b> </events-target-a>',
      })
      ...
      glassEasel.triggerExternalEvent(eAi, eAw, 'customevent', undefined, {
        bubbles: true,
        composed: true,
      })
    ...
    it('should bubble from shadowRoot', function () {
      ...
      targets = [
        e3.shadowRoot.root,
        e3,
        e2.$.wrapper.childNodes[1],
        e2.$.wrapper.childNodes[1],
        e3,
        e1.$.wrapper.childNodes[1],
        e1.$.wrapper.childNodes[1],
        e3,
      ]
      glassEasel.triggerExternalEvent(e3, e3.shadowRoot.root, 'customevent', undefined, {
        bubbles: true,
        composed: true,
      })
      expect(events.length + targets.length).toBe(0)
      ...
      glassEasel.triggerEvent(e2.shadowRoot, 'customevent', undefined, {
        bubbles: true,
        composed: true,
      })
      expect(events.length + targets.length).toBe(0)
    ...
    it('should support capture phase', function () {
      ...
      glassEasel.triggerEvent(e2.$.inner, 'customevent', undefined, {
        bubbles: true,
        capturePhase: true,
        composed: true,
      })
    ...
    it('should support mutated event', function () {
      ...
      glassEasel.triggerEvent(e5.$.inner, 'customevent', undefined, {
        bubbles: true,
        capturePhase: true,
        composed: true,
      })
