...
describe('Element', function () {
  ...
  it('should support class segments', function () {
    ...
    e.setNodeClass('d1', 1)
    expect(e.$$.classList.value).toBe('c1 c2 d1 e1 e2')
    e.setNodeClass('')
    expect(e.$$.classList.value).toBe('d1 e1 e2')
    e.setNodeClass('c1 c2 c3')
    expect(e.$$.classList.value).toBe('c1 c2 c3 d1 e1 e2')
    e.setNodeClass('d1 d2', 1)
    expect(e.$$.classList.value).toBe('c1 c2 c3 d1 d2 e1 e2')
    e.setNodeClass('', 1)
    expect(e.$$.classList.value).toBe('c1 c2 c3 e1 e2')
    e.setNodeClass('e1', 2)
    expect(e.$$.classList.value).toBe('c1 c2 c3 e1')
    e.setNodeClass('d1 d2 d3', 1)
    expect(e.$$.classList.value).toBe('c1 c2 c3 d1 d2 d3 e1')
    e.setNodeClass('e1 e2', 2)
    expect(e.$$.classList.value).toBe('c1 c2 c3 d1 d2 d3 e1 e2')
    e.setNodeClass('', 2)
