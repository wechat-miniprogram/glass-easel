...
describe('Selector', function () {
  ...
  describe('#querySelector, #querySelectorAll', function () {
    ...
    it('should be able to select all matched nodes (with deep selector)', function () {
      ...
      expect(parent.querySelectorAll('.b >>> #a1, .b >>> #a2')).toStrictEqual([
        elem.$.a1,
        elem.$.a1.$.a1,
        elem.$.a1.$.a2,
        elem.$.a2,
      ...
      expect(parent.querySelectorAll('.b >>> #a2, .b >>> #a1')).toStrictEqual([
        elem.$.a1,
        elem.$.a1.$.a1,
        elem.$.a1.$.a2,
        elem.$.a2,
      ...
      expect(parent.querySelectorAll('.b >>> #a2')).toStrictEqual([
        elem.$.a1.$.a2,
        elem.$.a2,
        elem.$.a2.$.a2,
      ])
      expect(parent.querySelectorAll('.b >>> #b, .b >>> #a2')).toStrictEqual([
        elem.$.a1.$.a2,
        elem.$.b,
        elem.$.a2,
        elem.$.a2.$.a2,
      ])
      expect(parent.querySelectorAll('.b >>> .common')).toStrictEqual([
        elem.$.a1.$.a1,
        elem.$.a1.$.a2,
        elem.$.b,
        elem.$.a2.$.a1,
      ...
      expect(parent.querySelectorAll('.b >>> #a2.common')).toStrictEqual([
        elem.$.a1.$.a2,
        elem.$.a2.$.a2,
      ])
